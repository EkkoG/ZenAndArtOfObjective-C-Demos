...
struct ThemeManager {
    static func applyTheme(theme: Theme) {
        ...
        UISlider.appearance().setMaximumTrackImage(UIImage(named: "maximumTrack")?.resizableImageWithCapInsets(UIEdgeInsets(top: 0, left: 0, bottom: 0, right: 6)), forState: .Normal)
        UISlider.appearance().setMinimumTrackImage(UIImage(named: "minimumTrack")?.resizableImageWithCapInsets(UIEdgeInsets(top: 0, left: 0, bottom: 0, right: 6)), forState: .Normal)
